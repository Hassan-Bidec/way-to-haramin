          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div className="flex-1 space-y-3">
              ...
              <div className='flex gap-2'>
                ...
                <Badge variant="outline" className="border-[#0E3C2F] text-[#0E3C2F] bg-[#0E3C2F]/5 mt-2">
                  {ride.status === 1 ? t("Pending") : ride.status === 2 ? t("Confirmed") : ride.status === 3 ? t("Cancel") : t("Completed")}
                </Badge>
              </div>
            </div>
  ...
  <AlertDialogHeader>
    ...
    <AlertDialogDescription className="text-gray-600">
      {rideToCancel !== null && upcomingRides[rideToCancel] && (
        <>
          {t("You are about to cancel your package from")}{" "}
    ...
    <div className="space-y-2">
      ...
      <Select value={cancelReason} onValueChange={setCancelReason}>
        ...
        <SelectContent className="bg-white">
          ...
          <SelectItem value="Found alternative transport">{t("Found alternative transport")}</SelectItem>
