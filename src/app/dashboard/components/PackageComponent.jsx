  ...
  if (!packageDetail) {
    return <div className="min-h-screen bg-background flex items-center justify-center">
      <div className="text-center">
        <p className="text-gray-500 mb-4">{t("Package not found")}</p>
          ...
          <div className="max-w-7xl mx-auto w-full">
            ...
            <div className="flex flex-wrap items-center gap-4 text-white">
              <div className="flex items-center gap-2 bg-white/20 px-4 py-2 rounded-lg">
                ...
                <span className="font-medium">{t(packageDetail.duration)}</span>
              </div>
        ...
        <CardContent className="p-5">
          ...
          <div className="flex items-center gap-2 mb-3 pb-3 border-b border-[#C7A76C]/30">
            ...
            <h3 className="flex-1 text-[#1B2A3D]">
              {t(cityItinerary.city)} {t("Journey")}
            </h3>

            <Badge className="bg-[#0E3C2F] text-white">
              {t("City")} {index + 1}
            </Badge>
          </div>
